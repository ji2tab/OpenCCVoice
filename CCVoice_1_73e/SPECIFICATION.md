...
- n####                … 最小受信長（ms）
- b####                … 最大受信長（ms）
- i####                … 直前アイドル時間（ms）/ postTxIgnore 解除閾値も兼ねる
- s0 / s1              … 抑止 OFF / ON
- t0 / t1              … 送信後抑止 OFF / ON
...
- k0（periodQuietMs=0）は再起動後に 2000ms に補完される場合がある
