 ...
 * Version : 2.24  (Code Optimization & C++ Safety)
...
void setup() {
  ...
  Serial.println(F("[START] OpenCCVoice v2.24 (Event Log, Dual EEPROM, RTC-Aligned Periodic, Ver.5 pinmap)"));
  printSummary();
  printHelp();
