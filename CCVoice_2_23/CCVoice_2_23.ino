 ...
 * Version : 2.23  (Fix TX/RX pin assignment + Compile error fix)
...
void setup() {
  ...
  Serial.println(F("[START] OpenCCVoice v2.23 (Event Log, Dual EEPROM, RTC-Aligned Periodic, Ver.5 pinmap)"));
  printSummary();
  printHelp();
