 ...
 * Version : 2.20  (Dual EEPROM: AT24C32 + Internal)
 ...
 * - EEPROM CONFIG_VERSION = 6（v2.10=5 からの自動マイグレーション）
 *   ※ saveTimestamp フィールドを追加
 *
 * 【v2.10 変更点】
...
void setup() {
  ...
  Serial.println(F("[START] OpenCCVoice v2.20 (Dual EEPROM, RTC-Aligned Periodic, Ver.5 pinmap)"));
  printSummary();
  printHelp();
}
