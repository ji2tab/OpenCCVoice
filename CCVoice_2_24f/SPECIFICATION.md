**===== 仕様書（技術者向け） OpenCCVoice Guidance Controller v2.24f =====**

1. 基本情報
- 名称      : OpenCCVoice Guidance Controller
- バージョン : v2.24f — V/Z コマンド追加版
...
------|---------------------|--------|-------------------------------|----------------------------
 ...
 D13  | ARD_TX_TO_DFP       | 出力   | Arduino TX → DFPlayer RX     | SoftwareSerial 9600bps ★v2.23修正
 D12  | ARD_RX_FROM_DFP     | 入力   | Arduino RX ← DFPlayer TX     | SoftwareSerial 9600bps ★v2.23修正
...
- v0                   … ログ消去（v2.21追加）
- V                    … バージョン表示（スケッチver + EEPROM_VER）（v2.24f追加）
- Z                    … ソフトウェアリセット（WDT 15ms / EEPROM変更なし）（v2.24f追加）
